      ...
      <Grid item xs={12} sm={6} md={4} lg={3}>
        <PostCard elevation={0}>
          <ImageContainer onClick={handleDialogOpen}>
            <PostImage src={post.image} alt={post.favorite_painting} />
          </ImageContainer>
          <PostInfo>
            <PostTitle>
      ...
      <Dialog open={showDialog} onClose={handleDialogClose} maxWidth="md">
        ...
        <DialogContent>
          <Box sx={{ display: 'flex', flexDirection: 'column', gap: 2 }}>
            ...
            <Typography variant="subtitle2" color="textSecondary">
              Favorite Painting: {post.favorite_painting}
            </Typography>
            <Typography variant="subtitle2" color="textSecondary">
              Style: {post.favorite_painting_style}
            </Typography>
            <Typography variant="subtitle2" color="textSecondary">
