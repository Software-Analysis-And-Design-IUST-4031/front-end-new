...
import { Box, Pagination, CircularProgress, Alert, FormControl, InputLabel, Select, MenuItem, TextField, InputAdornment, useTheme } from '@mui/material';
import SearchIcon from '@mui/icons-material/Search';
import Card from './cpainter';
      ...
      <Box sx={{ display: 'flex', flexDirection: 'column', gap: 5, mb: 8 }}>
        ...
        {loading ? (
          ...
          <Box sx={{ display: 'flex', justifyContent: 'center', alignItems: 'center', minHeight: '60vh' }}>
            <Alert severity="error" sx={{ backgroundColor: theme.palette.background.paper }}>
              {error}
            </Alert>
          </Box>
        ) : (
