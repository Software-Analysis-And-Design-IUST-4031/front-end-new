...
import { TCustomControl } from './Toolbar'
...
export const atomicBlockExists = (name: string, controls?: TCustomControl[]) => {
    if (!controls) {
        return undefined
    }
...
export const getEditorBounds = (editor: HTMLElement) => {
...
export const getLineNumber = (editorState: EditorState) => {
