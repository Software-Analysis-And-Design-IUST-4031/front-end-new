...
const Painter: React.FC = () => {
    ...
    const fetchPainters = async () => {
        setLoading(true);
        try {
            const response = await axios.get<ApiResponse>('/api/painting/user/top-painters/', {
    ...
    const handleScrollClick = () => {
        const bestPaintingsSection = document.getElementById('best-paintings-section');
        ...
        >
            <Container maxWidth="xl" sx={{ py: 8 }}>
                ...
                >
                    ...
                    >
                        Discover our most talented and popular artists showcasing their unique styles and creative visions
                    </Typography>
                </Box>
