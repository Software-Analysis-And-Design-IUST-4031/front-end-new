  ...
  const features = [
    {
      ...
      description: 'Create stunning digital artworks with our advanced tools and features.',
    },
    {
      icon: <StorefrontIcon />,
      title: 'Art Marketplace',
      description: 'Buy and sell original digital art in a secure and vibrant marketplace.',
    },
    {
      icon: <GroupsIcon />,
      title: 'Artist Community',
      description: 'Connect with fellow artists, share ideas, and grow together.',
    },
  ];
    ...
    >
      <Container maxWidth="lg">
        <Box sx={{ textAlign: 'center', mb: 8 }}>
          ...
          >
            Discover the unique features that make our platform the perfect place for digital artists
          </Typography>
        </Box>
